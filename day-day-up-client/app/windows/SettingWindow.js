...
class SettingsWindow {
    ...
    createSettingsWindow() {
        this.settingsWindow = new BrowserWindow({
            width: Common.WINDOW_SETTING_SIZE.width,
            height: Common.WINDOW_SETTING_SIZE.height,
            show: false,
            resizable: false,
        ...
        this.settingsWindow.loadURL(`file://${path.join(__dirname, './../client-views/setting.html')}`);
    }
